---
title: "Learning `renv` for Reproduciblity"
...
- Software is no longer available? Not reproducible.
- Computational environment is undocumented? Probably not.
- Software versions are undocumented? Eventually no.

We think that we have one of these issues whipped, then some unexpected development or complication throws reproducibility back in doubt.
I think this is especially true for someone like me: an intermediate R user who has no formal background in computer science or programming other than what I have learned on my own in the last couple years.
...
I will update this post with tips and lessons learned as long as I use `renv`.
...
I think all scientists and researchers who use R and who are committed to research reproducibility should adopt `renv` (or a similar package documentation tool) into their workflow.
